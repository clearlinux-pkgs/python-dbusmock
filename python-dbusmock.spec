...
Source0  : https://files.pythonhosted.org/packages/d5/3a/7f78101141fe9475c1c2265336e1fae6189a65b4205c6696e02bc2195c18/python-dbusmock-0.24.0.tar.gz
...
%prep
%setup -q -n python-dbusmock-0.24.0
cd %{_builddir}/python-dbusmock-0.24.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630341168
...
cp %{_builddir}/python-dbusmock-0.24.0/COPYING %{buildroot}/usr/share/package-licenses/python-dbusmock/f45ee1c765646813b442ca58de72e20a64a7ddba
